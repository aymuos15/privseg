...
def inference():
    ...
    model_path = os.path.join(project_root, 'checkpoints/mask2former_model.pth')
    ...
    # Get random 100 test images (different seed than training, same as U-Net)
    ...
    # Print results
    print("\n" + "="*50)
    print("MASK2FORMER INFERENCE RESULTS")
    print("="*50)
